...
Description: Put a flash box with crossfading images on your site. All configuration options (size,timings,images,...) accessible via the WP admin panel.
Version: 1.0 (beta)
Author: Marcus Grellert
Author URI: http://www.lynk.de/

Copyright (c) 2005 Marcus Grellert
Code on this page released under the MIT license
http://www.opensource.org/licenses/mit-license.html


Additional Credits:
Original crossfading slide show flash by Todd Dominey
...
function lynkff_displayForm()
{
	...
	Image display time: <input type="text" name="lynkff_time" class="lynkff" value="'.$_POST['lynkff_time'].'" />sec. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Image2Image fade time: <input type="text" name="lynkff_fade" class="lynkff" value="'.$_POST['lynkff_fade'].'" />sec.
	<br /><br />
